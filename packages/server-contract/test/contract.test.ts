...
const INTENTIONAL_OPTIONAL_SERVER_FIELDS: Record<string, string> = {
  ...
  "createAutomationRequestSchema.action.threadRequest.questionPolicy": "Automation creation may omit questionPolicy and inherit the scheduled thread default.",
  ...
  "updateAutomationRequestSchema.action.threadRequest.questionPolicy": "Automation action updates may omit questionPolicy and inherit the scheduled thread default.",
  ...
  "createManagerThreadRequestSchema.questionPolicy": "Manager creation may omit questionPolicy and use the server default for that thread class.",
  ...
  "createThreadRequestSchema.questionPolicy": "Thread creation may omit questionPolicy and use the server default for that thread class.",
  ...
  "sendMessageRequestSchema.questionPolicy": "Follow-up sends may omit questionPolicy and inherit the thread's current execution policy.",
