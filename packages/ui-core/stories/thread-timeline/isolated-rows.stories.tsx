...
function rendererUpdateChange() {
  return storyFileChange({
    ...
    kind: "update",
    diff: [
      "diff --git a/packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx b/packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
      "--- a/packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
      "+++ b/packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
...
function deletedLegacyStoryChange() {
  return storyFileChange({
    path: "packages/ui-core/stories/thread-timeline/legacy-row-fixture.tsx",
    kind: "delete",
    diff: [
...
function renamedStoryChange() {
  return storyFileChange({
    path: "packages/ui-core/stories/thread-timeline/full-rows.stories.tsx",
    kind: "rename",
    movePath: "packages/ui-core/stories/thread-timeline/rows.stories.tsx",
    diff: null,
    diffStats: {
      added: 0,
      removed: 0,
...
function nestedTurnRows() {
  return [
    ...
    commandRow({
      id: "nested-read-1",
      command:
        "sed -n '1,220p' packages/ui-core/stories/thread-timeline/rows.stories.tsx",
      activityIntents: [
        readIntent({
          path: "packages/ui-core/stories/thread-timeline/rows.stories.tsx",
        }),
      ],
  ...
  },
  {
    ...
    rows: [
      commandRow({
        ...
        output: "M packages/ui-core/stories/thread-timeline/rows.stories.tsx",
        seq: 4,
      }),
      commandRow({
        id: "bundle-command-2",
...
const activeLeafCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        ...
        command: "pnpm --filter @bb/ui-core ladle:build",
...
const mutedSummaryCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        ...
        command:
          "cat packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx && rg TimelineTitle packages/thread-view/src",
        activityIntents: [
          readIntent({
            path: "packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
          }),
...
const toolAndWebCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        ...
        command:
          "cat packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx && rg buildTimelineRowTitle packages/thread-view/src && ls packages/ui-core/stories",
        activityIntents: [
          readIntent({
            path: "packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
          }),
          ...
          listFilesIntent({
            path: "packages/ui-core/stories/thread-timeline",
          }),
        ],
  ...
  },
  {
    ...
    rows: [
      toolRow({
        id: "errored-tool",
        toolName: "Read",
        label: "Read packages/ui-core/src/thread-timeline/Missing.tsx",
        toolArgs: {
          file_path: "packages/ui-core/src/thread-timeline/Missing.tsx",
        },
        activityIntents: [
          readIntent({
            path: "packages/ui-core/src/thread-timeline/Missing.tsx",
          }),
        ],
  ...
  },
  {
    ...
    rows: [
      toolRow({
        id: "interrupted-tool",
        toolName: "Shell",
        label: "Shell pnpm exec turbo run test --filter=@bb/ui-core",
        toolArgs: {
          command: "pnpm exec turbo run test --filter=@bb/ui-core",
        },
    ...
    rows: [
      conversationRow({
        ...
        attachments: {
          ...
          localImagePaths: [],
          localFilePaths: [
            "/workspace/bb/packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
            "/workspace/bb/packages/ui-core/stories/thread-timeline/rows.stories.tsx",
          ],
        },
      }),
    ],
    ...
    rows: [
      conversationRow({
        ...
        attachments: {
          ...
          localImagePaths: [],
          localFilePaths: [
            "/workspace/bb/packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
            "/workspace/bb/packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx",
          ],
        },
      }),
    ],
      ...
      turnRow({
        ...
        children: [
          commandRow({
            ...
            command: "git status --short",
            output:
              "M packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx",
            seq: 102,
            turnId: "turn-inline",
          }),
          fileChangeRow({
      ...
      delegationRow({
        ...
        childRows: [
          commandRow({
            ...
            command: "pnpm exec turbo run typecheck --filter=@bb/ui-core",
            output:
              "packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx(1,1): error TS2307",
            seq: 107,
            status: "error",
            exitCode: 1,
      ...
      delegationRow({
        ...
        childRows: [
          commandRow({
            ...
            command: 'rg -n "web-fetch|delegation" packages/ui-core/stories',
            output:
              "packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx:640",
            seq: 109,
            status: "interrupted",
            exitCode: null,
  ...
  },
  {
    ...
    rows: [
      commandRow({
        ...
        command: 'rg -n "TimelineRowsStory" packages/ui-core/stories',
        activityIntents: [
          searchIntent({
            query: "TimelineRowsStory",
            path: "packages/ui-core/stories",
          }),
        ],
        output: "packages/ui-core/stories/thread-timeline/rows.stories.tsx:54",
        seq: 110,
      }),
      fileChangeRow({
