...
function rendererUpdateChange() {
  return storyFileChange({
    path: "packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
    kind: "update",
    diff: [
      "diff --git a/packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx b/packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
      "--- a/packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
      "+++ b/packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
...
function createdStoryChange() {
  return storyFileChange({
    path: "packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
    kind: "add",
    diff: [
...
function deletedFixtureChange() {
  return storyFileChange({
    path: "packages/ui-core/stories/thread-timeline/legacy-user-message.fixture.tsx",
    kind: "delete",
    diff: [
...
function renamedFixtureChange() {
  return storyFileChange({
    path: "packages/ui-core/stories/thread-timeline/user-message.stories.tsx",
    kind: "rename",
    movePath:
      "packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
    diff: null,
    diffStats: {
      added: 0,
      removed: 0,
...
function turnDetailRows() {
  return [
    ...
    commandRow({
      ...
      command:
        "sed -n '720,790p' packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx",
...
const stepSummaryCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        ...
        command:
          "sed -n '1,220p' packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx",
        activityIntents: [
          readIntent({
            path: "packages/ui-core/stories/thread-timeline/isolated-rows.stories.tsx",
          }),
        ],
        seq: 20,
      }),
      commandRow({
        ...
        command: 'rg -n "UserMessageStates" packages/ui-core/stories',
        activityIntents: [
          searchIntent({
  ...
  },
  {
    ...
    rows: [
      commandRow({
        ...
        output:
          "M packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
        seq: 22,
      }),
      fileChangeRow({
...
const activeBundleCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        ...
        command:
          "sed -n '1,140p' packages/ui-core/fixtures/thread-timeline-rows.ts",
        activityIntents: [
          readIntent({
            path: "packages/ui-core/fixtures/thread-timeline-rows.ts",
          }),
        ],
      ...
      commandRow({
        ...
        command: "ls packages/ui-core/stories/thread-timeline",
        activityIntents: [
          listFilesIntent({
  ...
  },
  {
    ...
    rows: [
      commandRow({
        ...
        command: "git diff -- packages/ui-core/stories/thread-timeline",
  ...
  },
  {
    ...
    rows: [
      toolRow({
        ...
        toolName: "Write",
        label:
          "Write packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
        approvalStatus: "waiting_for_approval",
        status: "pending",
        output: "",
        seq: 54,
  ...
  },
  {
    ...
    rows: [
      fileChangeRow({
        ...
        status: "error",
        stderr:
          "patch failed: packages/ui-core/src/thread-timeline/ConversationMessageContent.tsx:760",
        seq: 65,
        change: rendererUpdateChange(),
      }),
    ],
...
const explorationLeafCases: TimelineStoryCase[] = [
  {
    ...
    rows: [
      commandRow({
        id: "exploration-read",
        command:
          "sed -n '1,220p' packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
        activityIntents: [
          readIntent({
            path: "packages/ui-core/stories/thread-timeline/row-state-sweeps.stories.tsx",
          }),
      ...
      commandRow({
        ...
        command: 'rg -n "TimelineCaseGrid" packages/ui-core/stories',
        activityIntents: [
          searchIntent({
  ...
  },
  {
    ...
    rows: [
      commandRow({
        ...
        command:
          "sed -n '1,220p' packages/ui-core/src/thread-timeline/ThreadTimelineRows.tsx",
        activityIntents: [
          readIntent({
      ...
      commandRow({
        ...
        command: 'rg -n "compactActivityIntents" packages/ui-core/src',
        activityIntents: [
          searchIntent({
            query: "compactActivityIntents",
            path: "packages/ui-core/src",
          }),
        ],
      ...
      delegationRow({
        ...
        childRows: [
          commandRow({
            ...
            command:
              'rg -n "TimelineRowsStory" packages/ui-core/stories/thread-timeline',
