...
export {
  ...
  pendingInteractionExecPolicyAmendmentSchema,
  pendingInteractionFileChangeApprovalDecisionSchema,
  pendingInteractionFileSystemPermissionsSchema,
  pendingInteractionGrantedPermissionProfileSchema,
  pendingInteractionKindSchema,
  pendingInteractionMacOsAutomationPermissionSchema,
  pendingInteractionMacOsContactsPermissionSchema,
  pendingInteractionMacOsPermissionsSchema,
  pendingInteractionMacOsPreferencesPermissionSchema,
  pendingInteractionNetworkPolicyAmendmentDecisionSchema,
  pendingInteractionNetworkPolicyAmendmentSchema,
  pendingInteractionNetworkPolicyRuleActionSchema,
  ...
  pendingInteractionUserInputQuestionSchema,
...
export type {
  ...
  CommandApprovalPendingInteractionResolution,
  FileChangeApprovalPendingInteractionPayload,
  FileChangeApprovalPendingInteractionResolution,
  PendingInteraction,
  ...
  PendingInteractionExecPolicyAmendment,
  PendingInteractionExecPolicyAmendmentDecision,
  ...
  PendingInteractionNetworkPolicyAmendment,
  PendingInteractionNetworkPolicyAmendmentDecision,
  PendingInteractionNetworkPolicyRuleAction,
  PendingInteractionPayload,
  PendingInteractionPermissionFileSystemInput,
  PendingInteractionPermissionGrantScope,
  PendingInteractionPermissionMacOsAutomationInput,
  PendingInteractionPermissionMacOsBundleIdsInput,
  PendingInteractionPermissionMacOsInput,
  PendingInteractionPermissionNetworkInput,
  PendingInteractionPermissionProfileInput,
  PendingInteractionPermissionResolutionSummaryArgs,
  PendingInteractionQuestionOption,
  PendingInteractionQuestionOptionInput,
