...
3. No check prevents deleting the last source of a project. After deletion, the project has zero sources, which may break routes like GET /files or POST /managers that require a default source.
