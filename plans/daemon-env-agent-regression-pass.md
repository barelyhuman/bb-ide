...
9. Run the focused daemon/environment-agent unit tests plus the existing restart/follow-up e2e coverage to verify the fixes under realistic recovery flows.
