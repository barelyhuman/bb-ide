...
export const COARSE_POINTER_TOOLBAR_ACTION_BUTTON_CLASS =
  "h-7 rounded-md border-border bg-surface-raised px-2 text-xs font-medium text-foreground shadow-none hover:bg-state-hover hover:text-foreground max-md:pointer-coarse:h-9";
