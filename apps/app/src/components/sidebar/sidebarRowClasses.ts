...
export const SIDEBAR_PROJECT_GROUP_LINE_CLASS =
  "before:pointer-events-none before:absolute before:bottom-1 before:left-4 before:top-0 before:z-50 before:w-px before:bg-sidebar-border before:content-[''] max-md:pointer-coarse:before:left-5";
...
export const SIDEBAR_MANAGER_GROUP_LINE_CLASS =
  "before:pointer-events-none before:absolute before:bottom-1 before:left-10 before:top-0 before:z-50 before:w-px before:bg-sidebar-border before:content-['']";
