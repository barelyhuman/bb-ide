...
vi.mock("../hooks/useApi", () => ({
  ...
  useThreadTimelineToolDetails: () => apiState.pendingMutation,
  useSendThreadMessage: () => apiState.pendingMutation,
  useCreateThreadDraft: () => apiState.pendingMutation,
  useSendThreadDraft: () => apiState.pendingMutation,
  useDeleteThreadDraft: () => apiState.pendingMutation,
  useArchiveThread: () => apiState.pendingMutation,
  useRequestEnvironmentAction: () => apiState.pendingMutation,
