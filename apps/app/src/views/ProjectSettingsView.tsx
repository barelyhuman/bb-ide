  ...
  return (
    <PageShell contentClassName="pt-8 md:pt-10">
      <ProjectSettingsEditor
        key={project.id}
        projectId={projectId}
        initialInstructions={project.projectInstructions ?? ""}
  ...
  return (
    <div className="mx-auto w-full max-w-2xl space-y-3">
      ...
      <div className="space-y-1">
        <label htmlFor={`${projectId}-project-instructions`} className="text-xs font-medium text-muted-foreground">
          Project instructions
        </label>
        <textarea
          id={`${projectId}-project-instructions`}
